...
#pragma endregion
	private: System::Void HomeScreen_Load(System::Object^ sender, System::EventArgs^ e) {
		//NEEDS TO BE UPDATED IF COMPILED/RUN ON A DIFFERENT PC, PATH IS DIFFERENT WITH EACH PC.
		System::Drawing::Image^ image = System::Drawing::Image::FromFile("C:/Users/Kareem/Desktop/iCHEP/ArtificialNeuralNetworks/AIRobot.jpg");
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (dia->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
		...
		//IMAGES FOR TESTING THE PROGRAM ARE FOUND IN THE FOLLOWING DIRECTORY: ArtificialNeuralNetworks\Artificial-Neural-Network-in-Cpp-main\Project\test_set
